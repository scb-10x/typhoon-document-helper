        ...
        <div className="flex flex-col w-full bg-white border-t border-gray-200 overflow-hidden">
            <div className="flex-1 flex items-center px-2 py-1 flex-wrap gap-1">
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-purple-700 hover:bg-purple-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
